...
public class CheciCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public CheciCommentbackEntity() {

	}

	public CheciCommentbackEntity(T t) {
		try {
    ...
    public String toString() {
        return "CheciCommentback{" +
            ", id=" + id +
            ", checiId=" + checiId +
            ", yonghuId=" + yonghuId +
            ", checiCommentbackText=" + checiCommentbackText +
