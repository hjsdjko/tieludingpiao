...
public class CheciCollectionView extends CheciCollectionEntity implements Serializable {
	...
	*/
	...
	private String checiCollectionValue;
	...
	public CheciCollectionView() {

	}

	public CheciCollectionView(CheciCollectionEntity checiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, checiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getCheciCollectionValue() {
		return checiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setCheciCollectionValue(String checiCollectionValue) {
		this.checiCollectionValue = checiCollectionValue;
	}
	...
	public String toString() {
		return "CheciCollectionView{" +
			", checiCollectionValue=" + checiCollectionValue +
			", checiName=" + checiName +
